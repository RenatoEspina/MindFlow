...
/**
* Divide una cadena en una lista de substrings utilizando delimitadores.
*
* @param str   Cadena original que se quiere dividir.
* @param delim Cadena con los caracteres delimitadores.
*
* @return Una lista (List *) con los tokens generados a partir de str.
*/
